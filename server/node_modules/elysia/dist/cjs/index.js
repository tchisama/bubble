...
var getSchemaValidator = (s, {
  ...
  const cleaner = (value) => import_value.Value.Clean(schema, value);
  if (dynamic) {
    const validator = {
      schema,
      references: "",
...
var ValidationError = class _ValidationError extends Error {
  constructor(type, validator, value) {
    ...
    const accessor2 = error2?.path || "root";
    let message = "";
    if (customError) {
      ...
      const errors = "Errors" in validator ? [...validator.Errors(value)] : [...import_value2.Value.Errors(validator, value)];
      let expected;
      try {
...
var t2 = Object.assign({}, import_typebox2.Type);
...
if (!import_typebox2.FormatRegistry.Get("numeric"))
  import_typebox2.FormatRegistry.Set("numeric", (value) => !!value && !isNaN(+value));
if (!import_typebox2.FormatRegistry.Get("boolean"))
  import_typebox2.FormatRegistry.Set(
    "boolean",
    (value) => value === "true" || value === "false"
  );
if (!import_typebox2.FormatRegistry.Get("ObjectString"))
