...
var ValidationError = class _ValidationError extends Error {
  constructor(type, validator, value) {
    ...
    const error2 = isProduction ? void 0 : "Errors" in validator ? validator.Errors(value).First() : Value4.Errors(validator, value).First();
    ...
    if (customError) {
      ...
      const errors = "Errors" in validator ? [...validator.Errors(value)] : [...Value4.Errors(validator, value)];
      let expected;
      try {
        expected = Value4.Create(schema);
      } catch (error3) {
        expected = {
